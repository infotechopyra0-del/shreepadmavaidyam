...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { icon: Youtube, href: 'https://www.youtube.com/@shririturajsewasamiti', label: 'YouTube' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="hidden sm:block">
              <h1 className="font-playfair-display text-[1.75rem] leading-[1.8] tracking-[0.01em] text-[#FFFFFF] p-5">श्री पद्मवैद्यम</h1>
            </div>
          </Link>
            <p className="font-open-sans text-[1.125rem] tracking-[0.01em] font-normal text-[#FFFFFF]/80 leading-relaxed">
              एक अध्ययन स्थल जहाँ शाश्वत वैदिक परंपराएँ समकालीन शैक्षिक उत्कृष्टता के साथ मिलती हैं।
            </p>
          </div>
          {/* Quick Links */}
          <div>
            <h4 className="font-playfair-display text-[1.5rem] leading-[1.75] tracking-[0.01em] font-medium text-[#FFFFFF] mb-6">त्वरित लिंक</h4>
          ...
          {/* Curriculum */}
          <div>
            <h4 className="font-playfair-display text-[1.5rem] leading-[1.75] tracking-[0.01em] font-medium text-[#FFFFFF] mb-6">पाठ्यक्रम</h4>
            <ul className="space-y-3">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="font-playfair-display text-[1.5rem] leading-[1.75] tracking-[0.01em] font-medium text-[#FFFFFF] mb-6">संपर्क करें</h4>
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                <MapPin className="w-5 h-5 text-primary mt-1 shrink-0" />
                <span className="font-open-sans text-[1.125rem] leading-[1.6] tracking-[0.01em] font-normal text-[#FFFFFF]/80">
            ...
            <div className="mt-6">
              <p className="font-open-sans text-[1rem] tracking-[0.01em] font-normal text-[#FFFFFF]/70 mb-3">कार्यालय समय:</p>
              <p className="font-open-sans text-[1.125rem] leading-[1.6] tracking-[0.01em] font-normal text-[#FFFFFF]/80">
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-6">
              <span className="font-open-sans text-[1.125rem] leading-[1.6] tracking-[0.01em] font-normal text-[#FFFFFF]/70">हमें फॉलो करें:</span>
